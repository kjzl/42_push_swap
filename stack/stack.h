...
# define STACK_FAST_NEXT_INTERVAL 10
...
typedef struct s_node
{
	struct s_node	*next;
	struct s_node	*prev;
	/// The next node that is STACK_FAST_NEXT_INTERVAL nodes away.
	/// This value contains garbage if there is no such node.
	/// @warning Not circular.
